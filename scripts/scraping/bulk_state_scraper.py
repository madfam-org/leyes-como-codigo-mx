...
def main():
    ...
    for i, state in enumerate(states, 1):
        ...
        try:
            ...
            log(
                f"✅ {state_name} complete: {results['successful']}/{results['total_found']} laws"
            )
    ...
    log(
        f"Overall success rate: {total_stats['total_laws_downloaded']/total_stats['total_laws_found']*100:.1f}%"
    )
