...
def test_iva():
    ...
    if v1_file.exists():
        ...
        print(
            f"Articles:  V1={v1_articles}  V2={v2_articles}  Change={v2_articles-v1_articles:+d}"
        )
        print(
            f"Chapters:  V1={v1_chapters}  V2={v2_chapters}  Change={v2_chapters-v1_chapters:+d}"
        )
        print(
            f"Titles:    V1={v1_titles}  V2={v2_titles}  Change={v2_titles-v1_titles:+d}"
        )
