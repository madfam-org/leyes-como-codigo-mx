...
def ingest_lisr():
    ...
    bluebell = BluebellLite(
        frbr_uri=uri, title="Ley del Impuesto Sobre la Renta", date=pub_date
    )

    # Title I
    title_1 = bluebell.add_hierarchy(
        "title", "titulo-primero", "TITULO I - DISPOSICIONES GENERALES"
    )
    ...
    # Title IV
    title_4 = bluebell.add_hierarchy(
        "title", "titulo-cuarto", "TITULO IV - DE LAS PERSONAS FISICAS"
    )
