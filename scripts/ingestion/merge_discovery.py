...
def merge_registries():
    ...
    existing_by_remote = {law.get('remote_path', ''): law for law in registry['federal_laws'] if 'remote_path' in law}
    ...
    for new_law in discovered:
        ...
        if not matched:
            ...
            new_law['short_name'] = new_law['name'][:50] + "..." if len(new_law['name']) > 50 else new_law['name']
