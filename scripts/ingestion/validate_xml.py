...
def validate_akn_xml(xml_path: Path) -> bool:
    ...
    try:
        ...
        checks = {
            "meta": len(
                root.findall(
                    ".//{http://docs.oasis-open.org/legaldocml/ns/akn/3.0}meta"
                )
            ),
            "body": len(
                root.findall(
            ...
            "FRBRWork": len(
                root.findall(
                    ".//{http://docs.oasis-open.org/legaldocml/ns/akn/3.0}FRBRWork"
                )
            ),
            "FRBRExpression": len(
                root.findall(
                    ".//{http://docs.oasis-open.org/legaldocml/ns/akn/3.0}FRBRExpression"
                )
            ),
            "FRBRManifestation": len(
                root.findall(
                    ".//{http://docs.oasis-open.org/legaldocml/ns/akn/3.0}FRBRManifestation"
                )
            ),
            "article": len(
                root.findall(
            ...
            "chapter": len(
                root.findall(
                    ".//{http://docs.oasis-open.org/legaldocml/ns/akn/3.0}chapter"
                )
            ),
        }
        ...
        for element, count in checks.items():
            ...
            if (
                element
                in ["meta", "body", "FRBRWork", "FRBRExpression", "FRBRManifestation"]
                and count == 0
            ):
                all_good = False
