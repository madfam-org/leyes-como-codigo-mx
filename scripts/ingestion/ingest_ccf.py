...
def ingest_ccf():
    ...
    book_1 = bluebell.add_hierarchy(
        "book", "libro-primero", "LIBRO PRIMERO - DE LAS PERSONAS"
    )
    title_1 = bluebell.add_hierarchy(
        "title", "titulo-primero", "DE LAS PERSONAS FISICAS"
    )
    ...
    articles = [
        (
            "art-22",
            "La capacidad jurídica de las personas físicas se adquiere por el nacimiento y se pierde por la muerte; pero desde el momento en que un individuo es concebido, entra bajo la protección de la ley...",
        ),
        (
            "art-23",
            "La minoría de edad, el estado de interdicción y demás incapacidades establecidas por la ley, son restricciones a la personalidad jurídica...",
        ),
        (
            "art-24",
