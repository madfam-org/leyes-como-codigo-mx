...
class BluebellLite:
    ...
    def __init__(self, frbr_uri: str, title: str, date: datetime.date):
        ...
        self.root = ET.Element(
            "akomaNtoso", {"xmlns": self.NS["akn"], "xmlns:xsi": self.NS["xsi"]}
        )
    ...
    def _build_meta(self):
        ...
        identification = ET.SubElement(
            self.meta, "identification", {"source": "#antigravity"}
        )
        ...
        ET.SubElement(
            work, "FRBRdate", {"date": self.date.isoformat(), "name": "Generation"}
        )
        ...
        ET.SubElement(
            exp, "FRBRdate", {"date": self.date.isoformat(), "name": "Generation"}
        )
        ...
        ET.SubElement(
            man,
            "FRBRdate",
            {"date": datetime.date.today().isoformat(), "name": "Generation"},
        )
