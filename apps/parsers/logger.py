...
class StructuredLogger:
    ...
    def __init__(
        self, name: str, log_file: Optional[Path] = None, json_format: bool = False
    ):
        """
    ...
    def log_ingestion_start(self, law_id: str, law_name: str):
        ...
        self.logger.info(
            ...
            extra={
                "law_id": law_id,
                "extra_data": {"law_name": law_name, "event": "ingestion_start"},
            },
        )
    ...
    def log_ingestion_complete(self, law_id: str, duration: float, success: bool):
        ...
        self.logger.info(
            ...
            extra={
                ...
                "extra_data": {"event": "ingestion_complete", "success": success},
            },
        )
    ...
    def log_quality_check(self, law_id: str, metrics: Dict[str, Any]):
        ...
        self.logger.info(
            ...
            extra={
                "law_id": law_id,
                "extra_data": {"event": "quality_check", "metrics": metrics},
            },
        )
    ...
    def log_warning(self, law_id: str, message: str, context: Dict = None):
        ...
        self.logger.warning(
            ...
            extra={
                "law_id": law_id,
                "extra_data": {"event": "warning", "context": context or {}},
            },
        )
    ...
    def log_batch_complete(
        self, total: int, success: int, failed: int, duration: float
    ):
...
def main():
    ...
    logger.log_quality_check(
        "amparo", {"grade": "A", "accuracy": 98.3, "overall": 99.2}
    )
