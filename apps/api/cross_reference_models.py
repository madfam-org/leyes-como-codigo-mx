...
class CrossReference(models.Model):
    ...
    target_law_slug = models.CharField(max_length=255, db_index=True, null=True, blank=True)
    ...
    fraction = models.CharField(max_length=20, null=True, blank=True, help_text="Fraction number if specified")
    ...
    def __str__(self):
        return f"{self.source_law_slug}:{self.source_article_id} -> {self.reference_text}"
